...
set_false_path -from [get_cells {i_system_wrapper/system_i/maia_sdr/inst/control_registers/control/field_sdr_reset_reg/C}] -to [get_pins {i_system_wrapper/system_i/maia_sdr/inst/txiq_cdc/fifo/fifo18e1/RST}]
