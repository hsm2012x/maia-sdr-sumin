...
class LFM(Elaboratable):
    def __init__(self, tuning_word_width=32, lut_addr_width=10, sample_width=12):
        ...
        # --- LFM 파라미터 정의 ---
        self.tw_min = C(-699050666, signed(tuning_word_width)) # -2.5 MHz
        self.tw_max = C(699050666, signed(tuning_word_width))  # +2.5 MHz
        self.chirp_step = C(341333, signed(tuning_word_width))  # 주파수 증가량
    ...
    def elaborate(self, platform):
        ...
        # --- LFM(Chirp) 로직 ---
        freq_acc = Signal.like(self.tw_min, reset=-699050666)
