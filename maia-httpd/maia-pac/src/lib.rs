...
pub mod maia_sdr {
    ...
    pub mod tx_control {
        ...
        #[doc = "Field `start_1sec_pulse` writer - start_1sec_pulse"]
        pub type Start1secPulseW<'a, REG> = crate::BitWriter<'a, REG>;
        #[doc = "Field `delay_buffer` reader - delay_buffer"]
        pub type DelayBufferR = crate::FieldReader<u16>;
        #[doc = "Field `delay_buffer` writer - delay_buffer"]
        pub type DelayBufferW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
        impl R {
            #[doc = "Bit 0 - loopback"]
            #[inline(always)]
            ...
            #[doc = "Bits 2:17 - delay_buffer"]
            #[inline(always)]
            pub fn delay_buffer(&self) -> DelayBufferR {
                DelayBufferR::new(((self.bits >> 2) & 0xffff) as u16)
            }
        }
        impl W {
            #[doc = "Bit 0 - loopback"]
            #[inline(always)]
            pub fn loopback(&mut self) -> LoopbackW<'_, TxControlSpec> {
                LoopbackW::new(self, 0)
            }
            #[doc = "Bit 1 - start_1sec_pulse"]
            #[inline(always)]
            pub fn start_1sec_pulse(&mut self) -> Start1secPulseW<'_, TxControlSpec> {
                Start1secPulseW::new(self, 1)
            }
            #[doc = "Bits 2:17 - delay_buffer"]
            #[inline(always)]
            pub fn delay_buffer(&mut self) -> DelayBufferW<'_, TxControlSpec> {
                DelayBufferW::new(self, 2)
            }
        }
